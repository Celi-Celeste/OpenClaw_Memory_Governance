...
3. Weekly: drift review + soft forgetting
...
10 3 * * * /usr/bin/env python3 /path/to/skill/scripts/daily_consolidate.py --workspace /path/to/workspace --agent-id main >> /path/to/workspace/memory/logs/daily.log 2>&1
20 4 * * 0 /usr/bin/env python3 /path/to/skill/scripts/weekly_drift_review.py --workspace /path/to/workspace >> /path/to/workspace/memory/logs/weekly.log 2>&1
```
